...
Revision ID: 08d73186a327
Revises: 851e5cfc660e
Create Date: 2025-05-04 19:19:18.826269
...
revision: str = '08d73186a327'
down_revision: Union[str, None] = '851e5cfc660e'
...
def upgrade() -> None:
    ...
    op.add_column('reminders', sa.Column('course_name', sa.String(length=320), nullable=False))
    op.add_column('reminders', sa.Column('assignment_name', sa.String(length=320), nullable=False))
    op.add_column('reminders', sa.Column('deadline', sa.DateTime(), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('reminders', 'assignment_name')
    op.drop_column('reminders', 'course_name')
